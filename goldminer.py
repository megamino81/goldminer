...
def setup_gemstone():
    ...
    gemstone_group.add(Gemstone(gemstone_images[1], (800, 600), big_gold_price, big_gold_speed))
...
def load_image(filename):
    current_path = os.path.realpath('.') + '/res/'
...
sein = load_image("sein.png")
gemstone_images = [
    load_image("red_balloon.jpg"),
    load_image("pink_balloon.jpg"),
    load_image("dung.jpg"),
    load_image("flower.png"),
]
...
soundObj = pygame.mixer.Sound(os.path.realpath('.') + '/res/happy.wav')
soundObj.play()

#pygame.mixer.music.load(os.path.realpath('.') + '/res/happy.mp3')
